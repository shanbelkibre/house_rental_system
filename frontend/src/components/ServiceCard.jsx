...
export default function ServiceCard({ icon, title, description, linkTo, linkText }) {
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6 hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 group shadow-sm dark:shadow-none">
