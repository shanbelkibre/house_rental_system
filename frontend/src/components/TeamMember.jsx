export default function TeamMember({ image, name, role, bio, social }) {
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden hover:border-gray-300 dark:hover:border-white/20 transition-all duration-300 flex flex-col items-center text-center p-6 group shadow-sm dark:shadow-none">
      ...
      <p className="text-blue-600 dark:text-blue-500 text-sm font-medium mb-3">{role}</p>
      <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 leading-relaxed">
        {bio}
      </p>
      <div className="mt-auto flex space-x-3">
        {social?.twitter && (
          <a href={social.twitter} className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-blue-500 hover:text-white transition-colors">
        ...
        {social?.linkedin && (
          <a href={social.linkedin} className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-blue-700 hover:text-white transition-colors">
