...
export default function MyHousesPage() {
  ...
  const handleImageUpload = async () => {
    ...
    try {
      await api.post(`/houses/${imgModal}/images`, fd, {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
          ...
          {houses.map((h) => (
            ...
            >
              <div className="w-24 h-20 bg-gray-100 rounded-xl overflow-hidden flex-shrink-0">
                {h.images?.[0] ? (
                  <img
                    src={toStorageUrl(h.images[0].image_path)}
                    alt=""
                ...
                <div className="flex items-start justify-between gap-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      📍 {h.location} · 🛏 {h.rooms} rooms · ETB{" "}
                      {Number(h.price).toLocaleString()}/mo
                    </p>
                  </div>
                  <div className="flex gap-2 flex-wrap">
                    ...
                    />
                    <Badge
                      label={h.is_approved ? "Approved" : "Pending"}
      ...
      <Modal
        ...
        title={editing ? "Edit House" : "Add New House"}
      >
        <div className="space-y-3">
          ...
          <Input
            label="Location (Kebele / Kifle Ketema)"
            value={form.location}
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex gap-2 justify-end">
            <Button variant="outline" onClick={() => setImgModal(null)}>
              Cancel
            </Button>
            <Button
