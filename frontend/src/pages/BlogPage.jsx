  ...
  const posts = [
    {
      ...
      excerpt: "Finding a rental home can be stressful. Here are our top 10 tips to ensure you find a place that fits your needs and budget.",
    ...
    },
    {
      ...
      excerpt: "Great photos are the key to a successful listing. Learn how to stage and photograph your property like a pro.",
    ...
    },
    {
      ...
      excerpt: "Digital agreements are legally binding and easier to manage. We break down everything you need to know about signing online.",
    ...
    },
    {
      ...
      excerpt: "Don't forget anything on moving day! Use our comprehensive checklist to ensure a smooth transition to your new home.",
    ...
    },
    {
      ...
      excerpt: "Protect your investment by properly screening potential tenants. Here is how our platform helps you verify applicants.",
    ...
    },
    {
      ...
      excerpt: "Discover the best areas to live in Debre Birhan, with insights into local amenities, schools, and transportation.",
      image: "https://images.unsplash.com/photo-1519408469771-258609313b14?w=800&q=80",
      date: "Aug 20, 2025",
              ...
              <div className="relative rounded-3xl overflow-hidden h-[500px] w-full">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent flex flex-col justify-end p-8 md:p-12">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <span className="text-gray-300 text-sm">{posts[0].date}</span>
                  </div>
                  ...
                  <div className="flex items-center">
                    <div className="w-8 h-8 rounded-full bg-gray-700 mr-3 overflow-hidden">
                       <img src={`https://ui-avatars.com/api/?name=${encodeURIComponent(posts[0].author)}&background=random`} alt={posts[0].author} />
                    </div>
                    <span className="text-sm text-gray-300">{posts[0].author}</span>
                  </div>
                </div>
              </div>
            </Link>
