...
8 {
9     protected $table = 'reviews';
10     
11     protected $fillable = ['renter_id', 'house_id', 'rating', 'comment'];
12     
...
- Line 7: Defines the Review class.
- Line 8: Implements application logic: {
- Line 9: Declares a class property: protected $table = 'reviews';
- Line 10: Blank line for separation.
- Line 11: Declares a class property: protected $fillable = ['renter_id', 'house_id', 'rating', 'comment'];
